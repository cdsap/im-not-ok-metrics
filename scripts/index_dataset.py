...
def normalize_entry(run_dir: Path) -> dict:
    ...
    entry = {
        ...
        "android_application_module_hits": project_profile.get("android_application_module_hits"),
        "android_library_module_hits": project_profile.get("android_library_module_hits"),
        "android_dynamic_feature_module_hits": project_profile.get("android_dynamic_feature_module_hits"),
        "android_test_module_hits": project_profile.get("android_test_module_hits"),
        "unknown_module_count": project_profile.get("unknown_module_count"),
